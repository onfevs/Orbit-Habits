...
const Settings: React.FC<SettingsProps> = ({ settings, onUpdateSettings, onImportCSV, habits = [], logs = {} }) => {
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-200 dark:border-slate-700">
              <div className="flex flex-col">
                 ...
                 <span className="text-xs text-muted">Estadísticas cada domingo</span>
              </div>
              <button 
