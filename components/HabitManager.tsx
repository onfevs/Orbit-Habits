...
import {
  Plus, Trash2, Edit2, GripVertical, Package,
...
const HabitManager: React.FC<HabitManagerProps> = ({ habits, onAdd, onUpdate, onDelete, onReorder, onShowPacks }) => {
      ...
      <div className="flex justify-between items-center mb-6 gap-3">
        ...
        {!isAdding && (
          <div className="flex items-center gap-2">
            {onShowPacks && (
              <button
                onClick={() => { onShowPacks(); if (navigator.vibrate) navigator.vibrate(20); }}
                className="flex items-center gap-1.5 px-3 py-2 bg-surface border border-slate-700 hover:border-primary/40 text-slate-300 hover:text-primary rounded-lg text-sm font-semibold transition-all"
              >
